...
class TestUserShiftManagement(unittest.TestCase):
    ...
    def test_create_account_success(self, mock_create_user, mock_showinfo, mock_askstring):
    ...
    def test_delete_account_user_not_found(self, mock_get_user, mock_showwarning, mock_askstring):
    ...
    def test_promote_success(self, mock_update_user, mock_get_user, mock_askyesno, mock_showinfo, mock_askstring):
    ...
    def test_create_shift_success(self, mock_create_shift, mock_showinfo, mock_askstring):
